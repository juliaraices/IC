...
all <- read.table("table_allClasses.txt", header=T)
...
ggp2 <- ggplot(data.frame(tabe),aes(x=tabe$New_Class, tabe$age, color=tabe$age))
pdf("genes_interestnewclasses.pdf", width=9, height=8)
...
pdf("genes_interestnewclasses_proportion.pdf", width=9, height=8)
...
pdf("genes_interestclasses.pdf", width=9, height=8)
...
pdf("genes_interestclasses_proportion.pdf", width=9, height=8)
...
pdf("genes_numericclasses.pdf", width=9, height=8)
ggp2 + geom_histogram(aes(fill=tabe$age)) + labs(x="New expression classes", y="Number of genes") + ggtitle("Genes in each Expression Class during Spermatogenesis")
dev.off()

pdf("genes_numericclasses_proportion.pdf", width=9, height=8)
ggp2 + geom_histogram(aes(y=..count../sum(..count..), fill=tabe$age)) + labs(x="New expression classes", y="Frequency") + ggtitle("Frequency of each Expression Class during Spermatogenesis")
dev.off()
...
ggp3 <- ggplot(data.frame(tabe), aes(x=tabe$age, y=tabe$Mitosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Mitosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p ~ 0.249") + ggtitle("") + theme(legend.position = "none")


w4 <- wilcox.test(tabe$Meiosis~tabe$age)
ggp4 <- ggplot(data.frame(tabe), aes(x=tabe$age, y=tabe$Meiosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Meiosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p < 0.001") + ggtitle("") + theme(legend.position = "none") 

w5 <- wilcox.test(tabe$Post.meiosis~tabe$age)
ggp5 <- ggplot(data.frame(tabe), aes(x=tabe$age, y=tabe$Meiosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Post-Meiosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p < 0.001") + ggtitle("") + theme(legend.position = "none") 


library(gridExtra)
pdf("expression_possible_interest_classes.pdf", width=9, height=8)
...
w6 <- 
  wilcox.test(mei.pos.mit$Mitosis~mei.pos.mit$age)
ggp6 <- ggplot(data.frame(mei.pos.mit), aes(x=mei.pos.mit$age, y=mei.pos.mit$Mitosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Mitosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p ~ 0.125") + theme(legend.position = "none") 


w7 <- 
  wilcox.test(mei.pos.mit$Meiosis~mei.pos.mit$age)
ggp7 <- ggplot(data.frame(mei.pos.mit), aes(x=mei.pos.mit$age, y=mei.pos.mit$Meiosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Meiosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p < 0.001") + theme(legend.position = "none") 

w8 <- 
  wilcox.test(mei.pos.mit$Post.meiosis~mei.pos.mit$age)
ggp8 <- ggplot(data.frame(mei.pos.mit), aes(x=mei.pos.mit$age, y=mei.pos.mit$Meiosis, color=age)) + geom_boxplot(notch = T) + labs(x="Genes' age", y="Expression during Post-Meiosis") + theme(legend.position = "none") + annotate("text", x=1.5, y=13.5, label="p < 0.005") + theme(legend.position = "none") 


pdf("expression_interest_classes_notitle.pdf", width=9, height=8)
...
pdf("expression_all_classes.pdf", width=9, height=8)
