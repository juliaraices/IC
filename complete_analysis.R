...
cat("São paulo, July, 2015\n\n
	  ...
	  \tProportion of new and old genes in Mitotic, Meiotic and Post-Meiotic groups:")

table(mei.pos.mit$New_Class, mei.pos.mit$age)
prop.table(table(mei.pos.mit$New_Class, mei.pos.mit$age), 2)*100
cat("\t\t a) Test to check if the proportion of old and new genes is different between groups Mitotic and Meiotic:")
fisher.test(mit.mei$New_Class, mit.mei$age)
cat("\t\t b) Test to check if the proportion of old and new genes is different between groups Mitotic and Post-Meiotic:")
fisher.test(mit.pos$New_Class, mit.pos$age)
cat("\t\t c) Test to check if the proportion of old and new genes is different between groups Meiotic and Post-Meiotic:")
fisher.test(mei.pos$New_Class, mei.pos$age)

cat("\tProportion of new and old genes in Mitotic, Meiotic, Post-Meiotic and Meiotic-Post.Meiotic groups:")
tabela2 <- table(mei.pos.mit.meipos$New_Class, mei.pos.mit.meipos$age)
tabela2
prop.table(tabela2, 2) * 100
cat("\t\t d) Test to check if the proportion of old and new genes is different between groups Mitotic and Meiotic-Post.Meiotic:")
fisher.test(mit.meipos$age, mit.meipos$New_Class) # gente!!!!! deu certoooo!!!!!
cat("\t\t e) Test to check if the proportion of old and new genes is different between groups Meiotic and Meiotic-Post.Meiotic:")
fisher.test(mei.meipos$age, mei.meipos$New_Class) # gente!!!!! deu certoooo!!!!!
#nao-significatico para autossomos
cat("\t\t f) Test to check if the proportion of old and new genes is different between groups Meitotic-Post.Meiotic and Post.Meiotic:")
fisher.test(meipos.pos$age, meipos.pos$New_Class) # gente!!!!! deu certoooo!!!!!
#significativo para autossomos

cat("2) Expression of new and old genes in each group\n
	\t All autossomic genes from groups Mitotic, Meiotic, Post-Meiotic, Mitotic-Meiotic and Meiotic-Post.Meiotic:\n\
	t\t Expression during Mitosis:")
wilcox.test(tabe$Mitosis~tabe$age)
cat("\t\t Mean expression of new genes during Mitosis:")
mean(news$Mitosis)
cat("\t\t Mean expression of old genes during Mitosis:")
mean(old$Mitosis)
cat("\t\t Expression during Meiosis:")
wilcox.test(tabe$Meiosis~tabe$age)
cat("\t\t Mean expression of new genes during Meiosis:")
mean(news$Meiosis)
cat("\t\t Mean expression of old genes during Meiosis:")
mean(old$Meiosis)
cat("\t\t Expression during Post-Meiosis:")
wilcox.test(tabe$Post.meiosis~tabe$age)
cat("\t\t Mean expression of new genes during Post-Meiosis:")
mean(news$Post.meiosis)
cat("\t\t Mean expression of old genes during Post-Meiosis:")
mean(old$Post.meiosis)

cat("\t All autossomic genes from groups Mitotic, Meiotic and Post-Meiotic:\n\
	t\t Expression during Mitosis:")
...
cat("\t All autossomic genes from groups Mitotic, Meiotic, Post-Meiotic and Meiotic-Post.Meiotic:\n\
	t\t Expression during Mitosis:")
...
cat("\n\n 3) Wilcox tests used on graphs proportion_and_expression_mit_mei_pos.pdf:\n
	\t Expression of groups Mitotic, Meiotic, Post-Meiotic, Mitotic-Meiotic and Meiotic-Post.Meiotic during *Mitosis* against their age (old or new):")
...
cat("\t Expression of groups Mitotic, Meiotic, Post-Meiotic, Mitotic-Meiotic and Meiotic-Post.Meiotic during *Meiosis* against their age (old or new):")
...
cat("\t Expression of groups Mitotic, Meiotic, Post-Meiotic, Mitotic-Meiotic and Meiotic-Post.Meiotic during *Post-Meiosis* against their age (old or new):")
...
############### Writing things down ################
cat("\n\n4) Age and expression statistical comparisson for the genes from Mitotic, Mitotic-Meiotic, Meiotic, Meiotic-PostMeiotic and PostMeiotic groups used in the boxplots of Mitosis, Meiosis and Post-Meiosis expression in the proportion_and_expression_1to10and12.pdf file\n
...
cat("\n\n 5) Same expression analysis as 4, but now adding group Equal (groups Mitotic, Mitotic-Meiotic, Meiotic, Meiotic-Post.Meiotic, Post-Meiotic and Equal) used in the boxplots of Mitosis, Meiosis and Post-Meiosis expression in the proportion_and_expression_1to10and12and13.pdf file.\n
	\t Expression during Mitosis versus age:")
...
cat("\n\n 6) Just classes 14 and 15 (from Impossible group):
	\n\t a) Age and expression statistical comparisson for the genes from the 14 and 15 classes (Impossible group) used in the boxplots of Mitosis, Meiosis and Post-Meiosis expression in the proportion_expression_14and15.pdf file\n
	\t\t Expression during Mitosis versus age:")
...
cat("\t b) Proportion of new and old genes in each class:")
...
# stats
cat("\n\n 7) Statistic for all Numerical Classes used in the boxplots of Mitosis, Meiosis and Post-Meiosis expression in the expression_classes1_15.pdf file
	\n\tClass 1:
	\n\t\t Expression during Mitosis versus age:")
...
cat("8) Resume of comparison between classes to see if post-meiosis gets in the way of new genes (decreases the % of new genes in the classes where its expression is high)\n
	\t Table of absolute number e proportion of genes in each Class and age:")
print(table(tabe2$age, tabe2$CLASS))
print(prop.table(table(tabe2$age, tabe2$CLASS), 2)*100)

cat("\t a) Checking if classes 1 and 4 have a different proportion of old and new genes:")
print(fisher.test(classes1.4$age, classes1.4$CLASS))
cat("\t b) Checking if classes 3 and 8 have a different proportion of old and new genes:")
print(fisher.test(classes3.8$age, classes3.8$CLASS))
cat("\t c) Checking if classes 3 and 6 have a different proportion of old and new genes:")
print(fisher.test(classes3.6$age, classes3.6$CLASS))
cat("\t d) Checking if classes 3 and 10 have a different proportion of old and new genes:")
print(fisher.test(classes3.10$age, classes3.10$CLASS))
cat("\t e) Checking if classes 8 and 5 have a different proportion of old and new genes:")
print(fisher.test(classes8.5$age, classes8.5$CLASS))
cat("\t f) Checking if classes 8 and 7 have a different proportion of old and new genes:")
print(fisher.test(classes8.7$age, classes8.7$CLASS))
cat("\t g) Checking if classes 8 and 12 have a different proportion of old and new genes:")
print(fisher.test(classes8.12$age, classes8.12$CLASS))
cat("\t h) Checking if classes 8 and 4 have a different proportion of old and new genes:")
print(fisher.test(classes8.4$age, classes8.4$CLASS))
cat("\t i) Checking if classes 9 and 5 have a different proportion of old and new genes:")
print(fisher.test(classes9.5$age, classes9.5$CLASS))
cat("\t j) Checking if classes 9 and 7 have a different proportion of old and new genes:")
print(fisher.test(classes9.7$age, classes9.7$CLASS))
cat("\t k) Checking if classes 9 and 12 have a different proportion of old and new genes:")
print(fisher.test(classes9.12$age, classes9.12$CLASS))
cat("\t l) Checking if classes 9 and 4 have a different proportion of old and new genes:")
print(fisher.test(classes9.4$age, classes9.4$CLASS))
cat("\t m) Checking if classes 1 and 8 have a different proportion of old and new genes:")
print(fisher.test(classes1.8$age, classes1.8$CLASS))
cat("\t n) Checking if classes 1 and 9 have a different proportion of old and new genes:")
print(fisher.test(classes1.9$age, classes1.9$CLASS))
cat("\t o) Checking if classes 1 and 10 have a different proportion of old and new genes:")
print(fisher.test(classes1.10$age, classes1.10$CLASS))
cat("\t p) Checking if classes 1 and 6 have a different proportion of old and new genes:")
print(fisher.test(classes1.6$age, classes1.6$CLASS))

cat("\n\nFor information on classes and groups numbers, proportions, and distribuition across ages (old X new) please contact me for the XAanalysis.R and the table number_and_proportions_XandA.xls.\n\n")
